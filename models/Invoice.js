// models/Invoice.js - COMPLETE CLEAN VERSION
...
invoiceSchema.pre('save', async function () {
  console.log('🔄 Invoice pre-save hook triggered');
  
  // Generate invoice number if not exists (only for new documents)
  if (this.isNew && !this.invoiceNumber) {
    try {
      ...
      // Professional format: SF001, SF002, SF003, etc.
      this.invoiceNumber = `SF${String(counter.seq).padStart(3, '0')}`;
